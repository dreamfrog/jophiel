...
from jophiel.utils.helper import kwdict, retry_over_time
from jophiel.utils.compat import OrderedDict, LifoQueue as _LifoQueue
...
class BrokerConnection(object):
    ...
    def channel(self):
        ...
        if _LOG_CHANNEL:
            from jophiel.utils.debug import Logwrapped
