...
from jophiel.utils.cms.helpers import reversion_register
from jophiel.utils.cms.placeholder import get_placeholder_conf
...
class BlockPool(object):
    ...
    def register_plugin(self, plugin):
        ...
        if hasattr(plugin,'__iter__'):
            ...
            return
        if not issubclass(plugin, BaseBlock):
